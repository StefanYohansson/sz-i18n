...
Parser.prototype._toString = function (buf) {
  ...
  return decoder.decode(encoded).toString('utf-8');
};
...
PoParserTransform.prototype = Object.create(Transform.prototype);
PoParserTransform.prototype.constructor = Transform;
